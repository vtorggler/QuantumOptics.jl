...
function f3(alpha::Complex128, op::DenseOperator, h::LazyTensor, beta::Complex128, result::DenseOperator)
...
r3 = @benchmark f3(alpha, op, h, beta, result3)
